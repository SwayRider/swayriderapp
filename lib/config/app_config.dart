...
abstract final class AppConfig {
  ...
  static const authApiScheme = String.fromEnvironment(
    'AUTH_API_SCHEME',
    defaultValue: 'https',
  );
  ...
  static const authApiPort = int.fromEnvironment(
    'AUTH_API_PORT',
    defaultValue: 443,
  );
  ...
  static const tilesApiScheme = String.fromEnvironment(
    'TILES_API_SCHEME',
    defaultValue: 'https',
  );
  ...
  static const tilesApiPort = int.fromEnvironment(
    'TILES_API_PORT',
    defaultValue: 443,
  );
  ...
  static const searchApiScheme = String.fromEnvironment(
    'SEARCH_API_SCHEME',
    defaultValue: 'https',
  );
  ...
  static const searchApiPort = int.fromEnvironment(
    'SEARCH_API_PORT',
    defaultValue: 443,
  );
  ...
  /// When true, the access token loaded from secure storage at startup
  ...
  static const forceExpiredAccessToken = bool.fromEnvironment(
    'FORCE_EXPIRED_ACCESS_TOKEN',
  );

  /// Like [forceExpiredAccessToken], but also corrupts the refresh token
  /// loaded from secure storage, so the refresh call itself fails too
  /// (simulating a fully expired session). Debug-only.
  /// `--dart-define=FORCE_EXPIRED_REFRESH_TOKEN=true`
  static const forceExpiredRefreshToken = bool.fromEnvironment(
    'FORCE_EXPIRED_REFRESH_TOKEN',
  );
}
