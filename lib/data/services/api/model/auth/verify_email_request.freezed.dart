...
@JsonKey(name: 'email') String get email;@JsonKey(name: 'verification_url') String get verificationUrl;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VerifyEmailRequest&&(identical(other.email, email) || other.email == email)&&(identical(other.verificationUrl, verificationUrl) || other.verificationUrl == verificationUrl));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,email,verificationUrl);

@override
String toString() {
  return 'VerifyEmailRequest(email: $email, verificationUrl: $verificationUrl)';
}
...
@useResult
$Res call({
@JsonKey(name: 'email') String email,@JsonKey(name: 'verification_url') String verificationUrl
});
...
/// Create a copy of VerifyEmailRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? verificationUrl = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'email')  String email, @JsonKey(name: 'verification_url')  String verificationUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VerifyEmailRequest() when $default != null:
return $default(_that.email,_that.verificationUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'email')  String email, @JsonKey(name: 'verification_url')  String verificationUrl)  $default,) {final _that = this;
switch (_that) {
case _VerifyEmailRequest():
return $default(_that.email,_that.verificationUrl);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'email')  String email, @JsonKey(name: 'verification_url')  String verificationUrl)?  $default,) {final _that = this;
switch (_that) {
case _VerifyEmailRequest() when $default != null:
return $default(_that.email,_that.verificationUrl);case _:
  return null;
...
class _VerifyEmailRequest implements VerifyEmailRequest {
  const _VerifyEmailRequest({@JsonKey(name: 'email') required this.email, @JsonKey(name: 'verification_url') required this.verificationUrl});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _VerifyEmailRequest&&(identical(other.email, email) || other.email == email)&&(identical(other.verificationUrl, verificationUrl) || other.verificationUrl == verificationUrl));
}
...
/// Create a copy of VerifyEmailRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? verificationUrl = null,}) {
