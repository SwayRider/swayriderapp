...
void main() {
  ...
  test('autocomplete routes the api call through authRepository.withAuthRetry', () async {
    ...
    expect((result as Error<List<SearchResultItem>>).error, isA<UnauthorizedException>());
    verify(() => mockAuthRepository.withAuthRetry<List<SearchResultItem>>(any()))
        .called(1);
  });
}
